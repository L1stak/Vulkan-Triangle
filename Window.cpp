...
Window::Window(const char* title) {
    ...
    VkPhysicalDevice physicalDevice = devices.data()[0]; // текуща€ видеокарта
    
    vkGetPhysicalDeviceProperties(physicalDevice, &GPU_info); // информаци€ о видеокарте
    ...
    float queuePriority = 1.0f;  // приоритет выполнени€ задач, отрисовка или отображение, 1 - нейтрально
    ...
    swapChainCreateInfo.imageArrayLayers = 1; // кол-во возможных слоЄв дл€ отрисовки
